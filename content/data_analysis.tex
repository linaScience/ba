...
% To gain more information on the data, we will analyze the files in F1 of the site \begin{CJK*}{UTF8}{gbsn}银泰城(城西店)\end{CJK*}.
...
Also, we only have 2,027 waypoints for this floor but 1,862,044 lines of \ac{wifi} data, as seen in \cref{tab:data_summary}.
