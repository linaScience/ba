...
\begin{itemize}
    ...
    \item the chosen machine learning model is \ac{lstm} and is trained on real-world data from a dataset of a competition by Microsoft Research %TODO WHY lstm?
