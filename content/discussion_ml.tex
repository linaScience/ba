...
I will interpret each \ac{bssid} as a class,\fmhkn{AHA!} which translates to a high-dimensional classification problem with 4795 classes.
...
\fmhkn{ich lgaube, hier hatte sich nicht allzu viel verändert, oder? }